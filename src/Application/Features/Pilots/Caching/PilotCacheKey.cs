...
namespace CleanArchitecture.Blazor.Application.Features.Pilots.Caching;
...
public static class PilotCacheKey
{
    ...
    public static string GetByNameCacheKey(string parameters) {
        return $"PilotCacheKey:GetByNameCacheKey,{parameters}";
    }
    public static string GetByIdCacheKey(string parameters) {
        return $"PilotCacheKey:GetByIdCacheKey,{parameters}";
    }
    static PilotCacheKey()
    {
