...
namespace CleanArchitecture.Blazor.Migrators.SqLite.Migrations
{
    ...
    [Migration("20230922115253_SchoolBus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Student", null)
                        .WithMany()
                        .HasForeignKey("ChildrenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Parent", null)
                        .WithMany()
